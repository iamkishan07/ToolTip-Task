...
<Navbar variant="glass">
  ...
  const smallNavbar = `import { Navbar } from "@/components/navbar";
import { Button } from "@/components";
...
<Navbar size="sm">
  ...
  const largeNavbar = `import { Navbar } from "@/components/navbar";
import { Button } from "@/components";
...
<Navbar size="lg">
  ...
  const xlNavbar = `import { Navbar } from "@/components/navbar";
import { Button } from "@/components";
...
<Navbar size="xl">
  ...
  const fadeInNavbar = `import { Navbar } from "@/components/navbar";
import { Button } from "@/components";
...
<Navbar animation="fadeIn">
  ...
  const scaleInNavbar = `import { Navbar } from "@/components/navbar";
import { Button } from "@/components";

<Navbar animation="scaleIn">
  <h1>Logo</h1>
  ...
  const slideUpNavbar = `import { Navbar } from "@/components/navbar";
import { Button } from "@/components";

<Navbar animation="slideUp">
  <h1>Logo</h1>
  ...
  const bounceInNavbar = `import { Navbar } from "@/components/navbar";
import { Button } from "@/components";

<Navbar animation="bounceIn">
  <h1>Logo</h1>
  ...
  const noneAnimationNavbar = `import { Navbar } from "@/components/navbar";
import { Button } from "@/components";
